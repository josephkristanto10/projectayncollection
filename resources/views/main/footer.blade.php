...
<div class = "myfooter" style = "height:250px;background-color:#800e13;color:white;padding:20px;margin-top:10px;">
    <div class = "row justify-content-center">
        <div class = "col-2" style = "vertical-align:middle;margin-top:60px;">
            <h4>AYN Collection</h4>
            <p style = "font-size:12px;">“Make the mood with your outfit”</p>
        ...
        <div class = "col-3" style = "vertical-align:middle;text-align:left;">
            ...
            <p style = "font-size:12px;">Admin 1 : (Nomor Admin) </p>
            <p style = "font-size:12px;">Admin 2 : (Nomor Admin) </p>
        </div>
    </div>
</div>